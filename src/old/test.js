  ...
  for (let i = 0; i < resourceData.length; i++) {
    ...
    gltfloader.load(
      ...
      function (gltf) {
        ...
        link.innerHTML = resourceData[i].name
        link.addEventListener('click', function () {
          console.log('clicked')
          window.location = 'https://07kqr.csb.app/'
          window.location = 'https://07kqr.csb.app/'
        })
...
function lighthouse(pointlight, a) {
  pointlight.visible = true
  pointlight.position.set(a.position)
  pointlight.position.y = a.position.y + 30
